...
modify the contents of the `src/nemo_helix/lib/` and `examples/` directories.
...
```sh
$ pip install git+ssh://git@github.com/stainless-sdks/nemo-helix-python.git
```
...
You can release to package managers by using [the `Publish PyPI` GitHub action](https://www.github.com/stainless-sdks/nemo-helix-python/actions/workflows/publish-pypi.yml). This requires a setup organization or repository secret to be set up.
