...
"""Development tools MCP server for NeMo Helix.
...
Usage:
    uv run nhx-dev-mcp
    uv run nhx-dev-mcp --working-dir /path/to/repo
"""
...
def create_server(working_dir: str | None = None) -> FastMCP:
    ...
    """
    server = FastMCP("NeMo Helix Development Tools")
    ...
    async def run_pytest(
        ...
        Examples:
            ...
            - run_pytest("packages/nhx_common", verbose=False) - Run without verbose
        """
        import re
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="NeMo Helix Dev Tools MCP Server - Narrowly-scoped development operations"
    )
    parser.add_argument(
        "--working-dir",
        type=str,
    ...
    # Create server
    logger.info("Creating NeMo Helix dev tools MCP server...")
