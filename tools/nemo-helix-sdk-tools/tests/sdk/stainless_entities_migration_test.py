...
REMOVED_GENERATED_PATHS = (
    REPO_ROOT / "sdk/python/nemo-helix/src/nemo_helix/resources/entities",
    REPO_ROOT / "sdk/python/nemo-helix/src/nemo_helix/types/entities",
    REPO_ROOT / "sdk/python/nemo-helix/tests/api_resources/entities",
    REPO_ROOT / "sdk/python/nemo-helix/tests/api_resources/test_entities.py",
)
