...
from nemo_helix_sdk_tools.sdk.core.openapi import OpenAPI, OpenAPIEndpoint
...
from nemo_helix_sdk_tools.sdk.source_owned_resources import (
    SourceOwnedResource,
    ...
    return OpenAPI(
        {
            ...
            "paths": {
                "/apis/secrets/v2/workspaces/{workspace}/secrets": {
                    "get": {
                        "responses": {
                            "200": _json_response("HelixSecretResponsesPage"),
                        }
                    },
                    "post": {
                        "requestBody": {
                            "content": {
                                "application/json": {
                                    "schema": _schema_ref("HelixSecretCreateRequest"),
                                }
                            }
                        },
                        "responses": {
                            "201": _json_response("HelixSecretResponse"),
                        },
                    },
                },
                "/apis/secrets/v2/workspaces/{workspace}/secrets/{name}/access": {
                    "get": {
                        "responses": {
                            "200": _json_response("HelixSecretAccessResponse"),
                        }
                    }
                },
                "/apis/secrets/v2/workspaces/{workspace}/secrets/{name}": {
                    "patch": {
                        "requestBody": {
                            "content": {
                                "application/json": {
                                    "schema": _schema_ref("HelixSecretUpdateRequest"),
                                }
                            }
                        },
                        "responses": {
                            "200": _json_response("HelixSecretResponse"),
                        },
                    }
                },
                "/apis/secrets/v2/rotate-encryption-keys": {
                    "post": {
                        "responses": {
                            "202": _json_response("HelixSecretAdminRotationResponse"),
                        }
                    }
                },
            ...
            "components": {
                "schemas": {
                    "HelixSecretAccessResponse": {"type": "object"},
                    "HelixSecretAdminRotationResponse": {"type": "object"},
                    "HelixSecretCreateRequest": {"type": "object"},
                    "HelixSecretResponse": {"type": "object"},
                    "HelixSecretResponsesPage": {
                        "type": "object",
                        "properties": {
                            "data": {
                                "type": "array",
                                "items": _schema_ref("HelixSecretResponse"),
                            }
                        },
                    },
                    "HelixSecretUpdateRequest": {"type": "object"},
