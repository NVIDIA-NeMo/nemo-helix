...
REMOVED_SDK_API_DOC_RESOURCE_LINKS = {
    "src/nemo_helix/resources/access_keys/api.md",
    "src/nemo_helix/resources/auth/api.md",
    "src/nemo_helix/resources/iam/api.md",
}
...
def test_sdk_api_index_has_no_source_owned_auth_artifacts() -> None:
    api_index = (REPO_ROOT / "sdk" / "python" / "nemo-helix" / "api.md").read_text()
