...
via :attr:`~nemo_helix_plugin.job_context.JobContext.results`. Local runs use
:class:`~nemo_helix_plugin.job_results.LocalJobResults` wired by
:class:`~nemo_helix_plugin.scheduler.NemoJobScheduler`, so the artefact lands
