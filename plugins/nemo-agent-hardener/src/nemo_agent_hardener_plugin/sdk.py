...
from nemo_helix_plugin.client.adapter import HelixClient, client_from_platform
...
def _run_synth_benign(
    sync_sdk: HelixClient, *, manifest_id: str, env_file: str | None, interview: str, workspace: str
) -> JsonMap:
