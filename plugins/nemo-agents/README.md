...
`nemo agents package` renders `uv pip install "nemo-helix[nemo-agents-plugin]==<version>"`
...
|---|---|---|
| Config-only | No `--pyproject` | Install the release-matched `nemo-helix[nemo-agents-plugin]` runtime |
