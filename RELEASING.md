...
| Helm chart | OCI chart at `oci://ghcr.io/nvidia-nemo/nemo-helix` | Initially staged at `0921617854601259/nemo-helix`, then promoted to the public [NGC Helm repository](https://helm.ngc.nvidia.com/nvidia/nemo-helix) |
