...
For import commands, refer to [Import Gym rollout evidence](import-gym.md). For timestamp anchors,
rollout status, and duration, refer to the [Gym status and timing contract](gym-timing.md).
