...
LEGACY_PERSISTENT_JOB_STORAGE_PATH_ENVVARS = ("NHX_JOB_PERSISTENT_JOB_STORAGE_PATH",)

CURRENT_NEMO_JOB_STEP_CONFIG_FILE_PATH_ENVVAR = "NEMO_JOB_STEP_CONFIG_FILE_PATH"
LEGACY_NEMO_JOB_STEP_CONFIG_FILE_PATH_ENVVARS = ("NHX_JOB_STEP_CONFIG_FILE_PATH",)
