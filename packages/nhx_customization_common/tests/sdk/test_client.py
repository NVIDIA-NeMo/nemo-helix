...
def _status_response(status: HelixJobStatus = HelixJobStatus.COMPLETED) -> HelixJobStatusResponse:
...
def test_create_customization_job_endpoint_shape() -> None:
    from nhx.customization_common.sdk import endpoints
    from nhx.customization_common.sdk.types import CustomizationJob, CustomizationJobCreateRequest
...
def test_customization_job_preserves_legacy_job_alias() -> None:
    from nhx.customization_common.sdk.types import CustomizationJob
...
def test_jobs_resource_create_delegates_to_typed_customization_client() -> None:
    ...
    from nhx.customization_common.sdk.client import make_customization_sdk, make_customization_sdk_context
    from nhx.customization_common.sdk.types import CustomizationJob
    ...
    assert str(captured[0].url) == "http://nhx.test/apis/customization/v2/workspaces/team-a/automodel/jobs"
...
def test_jobs_resource_get_status_uses_core_jobs_client() -> None:
    ...
    assert len(captured) == 1
    assert str(captured[0].url) == "http://nhx.test/apis/jobs/v2/workspaces/team-a/jobs/job-a/status"
...
def test_jobs_resource_get_logs_uses_core_jobs_client() -> None:
    ...
    assert str(captured[0].url) == (
        "http://nhx.test/apis/jobs/v2/workspaces/team-a/jobs/job-a/logs"
...
async def test_async_customization_resource_accepts_typed_nemo_client_owner() -> None:
    ...
    from nemo_helix_plugin.client.response import AsyncNemoPaginatedResponse, NemoResponse
    from nhx.customization_common.sdk.client import (
    ...
    assert [str(request.url) for request in captured] == [
        "http://nhx.test/apis/customization/v2/workspaces/team-a/automodel/jobs",
        "http://nhx.test/apis/customization/v2/workspaces/team-a/automodel/jobs",
        "http://nhx.test/apis/customization/v2/workspaces/team-a/automodel/jobs/job-a",
        "http://nhx.test/apis/jobs/v2/workspaces/team-a/jobs/job-a/status",
    ]
