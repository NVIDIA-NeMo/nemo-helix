...
import pytest
from nhx.customization_common.tasks.file_io_utils import list_local_files, validate_safe_path
...
def test_validate_safe_path_rejects_unknown_absolute_path(tmp_path: Path) -> None:
    from nhx.customization_common.schemas.file_io import PathTraversalError
