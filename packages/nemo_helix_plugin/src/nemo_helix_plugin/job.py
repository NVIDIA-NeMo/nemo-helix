...
and invokes it through the :class:`~nemo_helix_plugin.scheduler.NemoJobScheduler`
...
:func:`~nemo_helix_plugin.discovery.discover_jobs` resolve jobs unambiguously
...
class NemoJob(_NamedPlugin):
    ...
    async def compile(
        ...
        *,
        ...
        """Compile the canonical spec into a ``HelixJobSpec``.
        ...
        ``HelixJobSpec`` the Jobs service expects by invoking it.
        ...
        Returns:
            A ``HelixJobSpec`` ready for the Jobs service.
    ...
    def report_progress(
        ...
        *,
        ...
        Args:
            ctx: The :class:`~nemo_helix_plugin.job_context.JobContext` for
                the running job.
