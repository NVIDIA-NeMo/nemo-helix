...
from nemo_helix_plugin.client.types import BinaryContent, CursorPagination, Paginated, PreparedRequest
...
@abstractmethod
def get_war_game_job_status(*, workspace: str | None = None, name: str) -> HelixJobStatusResponse: ...
...
@abstractmethod
def list_war_game_job_results(*, workspace: str | None = None, name: str) -> HelixJobListResultResponse: ...


@get(f"{_JOBS}/{{job}}/results/{{name}}")
@abstractmethod
def get_war_game_job_result(*, workspace: str | None = None, job: str, name: str) -> HelixJobResultResponse: ...
...
@abstractmethod
def get_synth_benign_job_status(*, workspace: str | None = None, name: str) -> HelixJobStatusResponse: ...
...
@abstractmethod
def list_synth_benign_job_results(*, workspace: str | None = None, name: str) -> HelixJobListResultResponse: ...


@get(f"{_SYNTH_JOBS}/{{job}}/results/{{name}}")
@abstractmethod
def get_synth_benign_job_result(*, workspace: str | None = None, job: str, name: str) -> HelixJobResultResponse: ...
