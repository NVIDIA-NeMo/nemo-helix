...
def get_nemo_helix_config() -> NemoHelixConfig:
    ...
    (e.g. nhx-common's HelixConfig with local-service routing) are respected.
    """
    return Configuration.get_platform_config()
...
# Aliases — nhx-common and services use HelixConfig / get_platform_config
HelixConfig = NemoHelixConfig
