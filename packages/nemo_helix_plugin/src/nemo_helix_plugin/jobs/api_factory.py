...
PlatformJobSpecCompiler = Callable[
    [str, JobInputT, JobOutputT, EntityClient, str | None, AsyncNeMoHelix],
    PlatformJobSpecLike | Awaitable[PlatformJobSpecLike],
]
PlatformJobSpecCompilerAsync = Callable[
    [str, JobInputT, JobOutputT, EntityClient, str | None, AsyncNeMoHelix], Awaitable[PlatformJobSpecLike]
]
...
InputToOutputTransformer = Callable[[JobInputT, str, EntityClient, str | None, AsyncNeMoHelix], JobOutputT]
InputToOutputTransformerAsync = Callable[
    [JobInputT, str, EntityClient, str | None, AsyncNeMoHelix], Awaitable[JobOutputT]
]
