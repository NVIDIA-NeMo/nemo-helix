...
import httpx
from nemo_helix_plugin.client.errors import NemoClientError, NemoHTTPError, NemoTransportError
from nemo_helix_plugin.jobs.client import (
    AsyncJobLogsClient,
...
def _status_event(status_response: HelixJobStatusResponse, job_name: str) -> JobStatusEvent:
...
def _log_event(log: HelixJobLog, job_name: str) -> JobLogEvent:
    return JobLogEvent(
        kind="log",
        job_name=job_name,
...
def _log_key(log: HelixJobLog) -> _LogKey:
