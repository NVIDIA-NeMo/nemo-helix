...
class HelixSecretResponse(BaseModel):
...
class HelixSecretAccessResponse(BaseModel):
...
class HelixSecretAdminRotationResponse(BaseModel):
...
class HelixSecretResponsesPage(Page[HelixSecretResponse]):
...
class HelixSecretCreateRequest(BaseModel):
