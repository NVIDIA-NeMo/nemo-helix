...
def test_platform_config_is_importable() -> None:
    """PlatformConfig is importable from nemo_helix_plugin.config."""
...
def test_nemo_helix_config_alias() -> None:
    """NemoHelixConfig is an alias for PlatformConfig."""
    assert NemoHelixConfig is PlatformConfig
...
def test_register_platform_config_class_controls_platform_config_accessors() -> None:
    ...
    class _RegisteredPlatformConfig(NemoHelixConfig):
    ...
    try:
        ...
        assert isinstance(NemoHelixConfig.get(), _RegisteredPlatformConfig)
