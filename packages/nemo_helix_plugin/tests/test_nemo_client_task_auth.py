...
"""Regression tests for the plugin-side (zero-nhx-common) NemoClient task path.
...
2. workload-identity must bootstrap bearer-token auth (no trusted X-NHX-* headers);
...
import pytest
from nemo_helix_plugin import client_provider as cp
