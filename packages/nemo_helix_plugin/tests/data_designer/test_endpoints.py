...
from nemo_helix_plugin.data_designer import endpoints
from nemo_helix_plugin.data_designer.types import (
...
def test_get_job_logs_endpoint_shape() -> None:
    ...
    assert prepared.response_type is HelixJobLogPage
...
def test_list_job_results_endpoint_shape() -> None:
    ...
    assert prepared.response_type is HelixJobListResultResponse
...
def test_get_job_result_endpoint_shape() -> None:
    ...
    assert prepared.response_type is HelixJobResultResponse
