...
"""Unit tests for nemo_helix_plugin.commands.
...
class TestFunctionSubmitVerb:
    ...
    def test_submit_uses_nhx_base_url_env_when_no_flags(self, monkeypatch) -> None:
        ...
        monkeypatch.setattr("nemo_helix_plugin.commands._post_function_submit", _fake_post)
        monkeypatch.setenv("NHX_BASE_URL", "http://from-env:1234")
...
class TestApiSegmentForFunction:
    ...
    def test_uses_registered_entry_point_key(self, monkeypatch) -> None:
        from nemo_helix_plugin.commands import _api_segment_for_function
...
class TestJobAutoSpecFlags:
    ...
    lockstep — the wiring is shared via :mod:`nemo_helix_plugin._spec_flags`.
    """
