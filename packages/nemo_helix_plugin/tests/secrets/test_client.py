...
def test_create_secret_sends_plaintext_value() -> None:
    ...
    resp = client.create_secret(body=HelixSecretCreateRequest(name="hf-token", value="nvapi-xyz"))
...
def test_update_secret_sends_plaintext_value() -> None:
    ...
    client = SecretsClient(base_url=BASE, workspace="default", http_client=mock_http)
    client.update_secret(name="hf-token", body=HelixSecretUpdateRequest(value="newvalue"))
...
async def test_async_create_secret() -> None:
    ...
    resp = await client.create_secret(body=HelixSecretCreateRequest(name="hf-token", value="nvapi-xyz"))
