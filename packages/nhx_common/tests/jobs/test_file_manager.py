...
from nemo_helix_plugin.jobs.file_manager import _filter_files_by_patterns
from nhx.common.jobs.file_manager import FilesetFileManager, FileStorageType
...
async def test_fileset_upload_directory_with_ignore_patterns(tmp_path, mock_fileset_fs):
    ...
    from nhx.common.jobs.file_manager import AsyncFilesetFileManager
