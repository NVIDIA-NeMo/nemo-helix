...
import pytest
import structlog
from nhx.common.observability.context import (
    AppContext,
...
def reset_app_context():
    ...
    from nhx.common.observability.context import _app_context
...
def test_auth_context_round_trips_stable_account_headers():
    headers = {
        ...
        "x-nhx-actor-account-id": "account-user",
        "x-nhx-principal-email": "user@example.com",
        "x-nhx-principal-groups": "team-a,team-b",
        "x-nhx-actor-aliases": "legacy-user,user@example.com",
        "x-nhx-principal-on-behalf-of": "delegate@example.com",
        "x-nhx-principal-on-behalf-of-email": "delegate@example.com",
        "x-nhx-principal-on-behalf-of-groups": "team-c",
        "x-nhx-subject-account-id": "account-delegate",
        "x-nhx-subject-aliases": "legacy-delegate",
    }
