...
from nhx.common.platform_endpoint import _AsyncPlatformEndpointRoutingTransport, _SyncPlatformEndpointRoutingTransport
...
class TestHeadersAuth:
    ...
    def test_merges_otel_propagation_headers_without_adding_internal_auth(self):
        with scoped_otel_headers({"traceparent": "00-trace-span-01", "X-NHX-Internal": "true"}):
        ...
        assert "X-NHX-Internal" not in client._default_headers
