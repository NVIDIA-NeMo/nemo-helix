...
AUTH_HEADER_USERID = "x-nhx-principal-id"
AUTH_HEADER_ACCOUNT_ID = "x-nhx-actor-account-id"
AUTH_HEADER_EMAIL = "x-nhx-principal-email"
AUTH_HEADER_FILTERS = "x-nhx-principal-filters"
AUTH_HEADER_GROUPS = "x-nhx-principal-groups"
AUTH_HEADER_ALIASES = "x-nhx-actor-aliases"
AUTH_HEADER_ON_BEHALF_OF = "x-nhx-principal-on-behalf-of"
AUTH_HEADER_ON_BEHALF_OF_EMAIL = "x-nhx-principal-on-behalf-of-email"
AUTH_HEADER_ON_BEHALF_OF_GROUPS = "x-nhx-principal-on-behalf-of-groups"
AUTH_HEADER_ON_BEHALF_OF_ACCOUNT_ID = "x-nhx-subject-account-id"
AUTH_HEADER_ON_BEHALF_OF_ALIASES = "x-nhx-subject-aliases"
...
class AppContext:
    ...
    def add_to_span(self, span: Span):
        if self.service_name:
            span.set_attribute("nhx.service", self.service_name)
        if self.workspace:
            span.set_attribute("nhx.workspace", self.workspace)
        if self.auth_ctx:
