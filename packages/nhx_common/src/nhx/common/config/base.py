...
Core config classes and PlatformConfig live in nemo_helix_plugin.config. This module
...
from nemo_helix_plugin.config import NemoHelixConfig as _PluginPlatformConfig
...
class AuthConfig(create_service_config_class("auth")):  # ty: ignore[unsupported-base]
    ...
    def get_pdp_url(self, entrypoint: str) -> str:
        ...
        # PlatformConfig from nhx.common.config, which is defined in this file.
