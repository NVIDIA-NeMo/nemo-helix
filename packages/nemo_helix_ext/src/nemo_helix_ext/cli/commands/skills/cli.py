...
def list_skills(
    ...
    source: Annotated[
        ...
        typer.Option(
            ...
            help=(
                ...
                "`Source` column, e.g. `nemo-helix`, `nemo-agents-plugin`). Can be repeated to "
    ...
    Examples:
      ...
      nemo skills list --source nemo-helix
      nemo skills list --source nemo-helix --source nemo-agents-plugin
    """
    ...
    items = [
        {
            ...
            # collapsed to `nemo-helix` for the platform's own packages.
