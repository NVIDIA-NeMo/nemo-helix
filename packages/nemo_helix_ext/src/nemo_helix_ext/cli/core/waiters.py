...
from nemo_helix_plugin.jobs.client import JobsWatchClient
...
class _WatchedJobsClient:
    def __init__(self, jobs_client: JobsWatchClient) -> None:
        ...
        self.last_status: HelixJobStatusResponse | None = None
...
class _HelixJobWaitLiveDisplay:
...
def wait_for_platform_job(
    ...
    *,
    ...
    live_display = _HelixJobWaitLiveDisplay(start_time=start_time, timeout=timeout, poll_interval=poll_interval)
