...
def handle_code_generation(
    ...
    *,
    ...
    if isinstance(client_cls, list):
        ...
        from nemo_helix_ext.cli.core.legacy_code_generator import handle_code_generation as legacy
...
def generate_python_code(
    ...
    *,
    ...
    if lifecycle_type == _INFERENCE_DEPLOYMENT_LIFECYCLE:
        ...
        imports.add_name("nemo_helix_plugin.client.errors", "NemoHTTPError")
        imports.add_name("nemo_helix_plugin.client.errors", "NemoTransportError")
        imports.add_name("nemo_helix_plugin.client.errors", "NotFoundError")
        imports.add_name("nemo_helix_plugin.inference_gateway.client", "InferenceGatewayClient")
