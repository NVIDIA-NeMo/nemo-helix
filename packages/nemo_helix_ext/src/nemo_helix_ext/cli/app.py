...
"""NeMo CLI - Command-line interface for NeMo Helix."""
...
from nemo_helix_ext.cli.core.help_formatter import HELP_OPTION_NAMES
from nemo_helix_ext.cli.core.lazy_load import (
    ManifestBackedNhxGroup,
    attach_lazy_entries,
)
from nemo_helix_ext.cli.core.logging import configure_logging
from nemo_helix_ext.cli.core.types import ListOutputFormat, TimestampFormat
from nemo_helix_ext.cli.manifest import (
    TopLevelEntry,
    build_top_level_entries,
)
from nemo_helix_ext.config.types import OutputFormat as ConfigOutputFormat
...
def _add_plugin_job_commands(
    ...
    *,
    ...
    # TODO: nemo-helix-plugin is temporarily optional while it is being published
    ...
    try:
        ...
        logger.warning("nemo_helix_plugin.commands unavailable; skipping plugin job command injection", exc_info=True)
        return
...
def _add_plugin_function_commands(
    ...
    *,
    ...
    # Same nemo-helix-plugin optionality guard as the jobs path. When the
    ...
    try:
        ...
        logger.warning(
            "nemo_helix_plugin.commands unavailable; skipping plugin function command injection",
            exc_info=True,
        )
        return
...
def main(
    ...
    base_url: Annotated[
        ...
        typer.Option(
            "--base-url",
            help="Base URL for the NeMo Helix API",
            rich_help_panel="Global Options",
        ),
    ] = None,
    ...
    :books: Documentation: https://docs.nvidia.com/nemo-helix
