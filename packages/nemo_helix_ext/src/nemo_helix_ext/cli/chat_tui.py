...
import click
from nemo_helix._streaming import SSEDecoder
...
from nemo_helix_ext.cli.core.help_formatter import _get_terminal_width
...
def _print_welcome_header(
    ...
    welcome_panel = Panel(
        "\n".join(config_lines),
        title="[bold green]🤖 NeMo Helix Chat Session[/bold green]",
