...
from .conftest import NhxCliRunner
...
class TestFilesetsUpload:
    ...
    def test_upload_without_workspace_is_usage_error(self, runner: NhxCliRunner, tmp_path: Path):
        test_file = tmp_path / "test.txt"
        test_file.write_text("Hello!")
...
class TestFilesetsDownload:
    ...
    def test_download_missing_fileset_is_remote_error(
        self, runner: NhxCliRunner, random_workspace: str, tmp_path: Path
    ):
...
class TestFilesListDelete:
    ...
    def test_list_files(self, runner: NhxCliRunner, fileset_with_nested_files: dict):
        result = runner.invoke(
            app,
    ...
    def test_list_files_remote_path_prefix(self, runner: NhxCliRunner, fileset_with_nested_files: dict):
        result = runner.invoke(
            app,
    ...
    def test_list_files_glob(self, runner: NhxCliRunner, fileset_with_nested_files: dict):
        result = runner.invoke(
            app,
    ...
    def test_list_files_table_columns(self, runner: NhxCliRunner, fileset_with_nested_files: dict):
        result = runner.invoke(
            app,
    ...
    def test_list_files_missing_fileset(self, runner: NhxCliRunner, random_workspace: str):
        result = runner.invoke(app, f"files list nope --workspace {random_workspace}")

        assert_exit_code(result, 3)
        assert "not found" in result.stderr.lower()

    def test_delete_file(self, runner: NhxCliRunner, files_client: FilesClient, fileset_with_nested_files: dict):
        result = runner.invoke(
            app,
    ...
    def test_delete_missing_file(self, runner: NhxCliRunner, fileset_with_nested_files: dict):
        result = runner.invoke(
            app,
...
class TestFilesetsCrud:
    ...
    def test_filesets_lifecycle(self, runner: NhxCliRunner, random_workspace: str):
        name = _fileset_name()
    ...
    def test_filesets_create_from_stdin(self, runner: NhxCliRunner, random_workspace: str):
        name = _fileset_name()
        result = runner.invoke(
            app,
    ...
    def test_filesets_create_exist_ok_returns_existing(self, runner: NhxCliRunner, random_workspace: str):
        name = _fileset_name()
        first = runner.invoke(
    ...
    def test_filesets_create_rejects_invalid_name_locally(self, runner: NhxCliRunner, random_workspace: str):
        result = runner.invoke(app, ["files", "filesets", "create", "X", "--workspace", random_workspace])
        assert_exit_code(result, 2)
        assert "Invalid input" in result.stderr
        assert "name" in result.stderr

    def test_filesets_list_filters_and_pages(self, runner: NhxCliRunner, random_workspace: str):
    ...
    def test_filesets_code_output_sends_nothing(self, runner: NhxCliRunner, random_workspace: str):
        result = runner.invoke(
