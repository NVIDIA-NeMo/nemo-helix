...
"""Tests for the NeMo Helix help formatter."""
...
import pytest
import typer
from nemo_helix_ext.cli.core.help_formatter import (
    NhxHelpFormatter,
    _get_terminal_width,
...
def mock_terminal_size(columns: int, lines: int = 24):
    ...
    with patch("nemo_helix_ext.cli.core.help_formatter.shutil.get_terminal_size") as mock_size:
...
class TestNhxHelpFormatter:
    ...
    def test_write_dl_single_line_format(self):
        ...
        formatter = NhxHelpFormatter(width=120)
        rows = [
            ("--help", "Show help"),
    ...
    def test_write_dl_wrapped_format(self):
        ...
        formatter = NhxHelpFormatter(width=40)
        rows = [
...
class TestNhxOption:
    """Tests for NhxOption formatting via help output."""
...
class TestNhxArgument:
    """Tests for NhxArgument formatting via help output."""
