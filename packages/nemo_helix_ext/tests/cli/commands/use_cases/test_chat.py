...
def test_chat_prompt_runs_once_with_plain_text_output(runner: CliRunner) -> None:
    ...
    with (
        patch("nemo_helix_ext.cli.core.context.CLIContext.get_client", return_value=mock_client),
...
def test_chat_one_shot_includes_system_message(runner: CliRunner) -> None:
    ...
    with patch("nemo_helix_ext.cli.core.context.CLIContext.get_client", return_value=mock_client):
