...
from nemo_helix import APIConnectionError, APIStatusError, APITimeoutError
from nemo_helix.resources.inference.providers import ProvidersResource
...
def _make_mock_client(*, provider_exists: bool = False, secret_exists: bool = False) -> MagicMock:
    """Build a mock NeMoHelix client with configurable provider/secret state.
