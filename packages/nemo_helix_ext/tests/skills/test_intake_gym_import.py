...
import pytest
from nhx.intake.spans.ingest.spans import DirectSpansIngestRequest, direct_span_to_domain

SCRIPTS = Path(__file__).resolve().parents[4] / "packages/nemo_helix_ext/src/nemo_helix_ext/skills/nemo-intake/scripts"
