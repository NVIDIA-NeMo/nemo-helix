...
def get_nhx_provider(sdk: NeMoHelix, workspace: str, provider_name: str) -> NHXModelProvider:
    models = client_from_platform(sdk, ModelsClient)
    return models.get_provider(workspace=workspace, name=provider_name).data()


async def get_nhx_provider_async(sdk: AsyncNeMoHelix, workspace: str, provider_name: str) -> NHXModelProvider:
