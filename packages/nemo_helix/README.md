...
Plain `pip install "nemo-helix[all]"` works in an environment you manage yourself.
...
The recommended developer setup is to clone the repo and use `make bootstrap` instead of installing from PyPI — see the [setup playbook](https://github.com/NVIDIA-NeMo/nemo-helix/blob/main/SETUP.md) for the full walkthrough, including local data dir, DB reset, and troubleshooting.
...
- **Build and optimize agents.** Open a coding agent session inside your agent's project directory and ask: _"Build and optimize an agent using NeMo Helix."_ The shipped skills will scaffold the agent, deploy it, run evaluations, suggest optimizations, and add guardrails on request.
- **Explore the platform.** From any coding agent session, ask: _"What can I do with NeMo Helix?"_ to get a guided tour of the capabilities surfaced through skills.
...
- **Source:** https://github.com/NVIDIA-NeMo/nemo-helix
- **Documentation:** https://docs.nvidia.com/nemo-helix/
- **Setup playbook:** https://github.com/NVIDIA-NeMo/nemo-helix/blob/main/SETUP.md
- **CLI reference:** https://docs.nvidia.com/nemo-helix/documentation/reference/cli-reference
- **API reference:** https://docs.nvidia.com/nemo-helix/documentation/reference/api-reference
- **Issue tracker:** https://github.com/NVIDIA-NeMo/nemo-helix/issues

## License

NeMo Helix is licensed under the [Apache License 2.0](https://github.com/NVIDIA-NeMo/nemo-helix/blob/main/LICENSE). Third-party open-source dependencies have their own licenses; review them before use.
