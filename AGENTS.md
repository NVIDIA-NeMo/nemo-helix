...
The Python SDK (`sdk/python/nemo-platform`) was historically generated by the Stainless SaaS from our OpenAPI spec and a Stainless config. That cloud generation step has been removed; the SDK is now hand-maintained in-repo.
