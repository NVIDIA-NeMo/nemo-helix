...
from nhx.guardrails.api.dependencies import RailsServiceDep
from nhx.guardrails.app.handlers.completion import (
...
@router.post(
    "/v2/workspaces/{workspace}/completions",
...
async def create_completion(
    ...
    request_handler = CompletionRequestHandler(
        ...
        normal_response_model=GuardrailCompletionResponse,
        streaming_response_model=GuardrailCompletionStreamResponse,
        workspace=workspace,
    )
