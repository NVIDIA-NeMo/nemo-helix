...
from nhx.common.files.storage_config import StorageConfig as StorageConfig
from nhx.common.files.storage_config import StorageConfigField as StorageConfigField
...
def storage_impl_factory(
    ...
    match config:
        ...
        case NGCStorageConfig():
            from nhx.core.files.app.backends.ngc import NGCStorageImpl
