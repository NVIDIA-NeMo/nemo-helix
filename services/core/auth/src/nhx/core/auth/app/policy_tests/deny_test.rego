...
# wildcard, and the HelixAdmin bypass.

deny_test_data := {
	"roles": {
		"Viewer": {"permissions": ["models.read"]},
		"HelixAdmin": {"includes": ["Viewer"], "permissions": ["iam.read"]},
	...
	"principals": {
		"platform-admin@example.com": {"workspaces": {"system": ["HelixAdmin"]}},
...
# Overrides the HelixAdmin allow-bypass.
