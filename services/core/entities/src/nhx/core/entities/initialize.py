...
from nhx.common.entities.constants import DEFAULT_WORKSPACE, SYSTEM_WORKSPACE
from nhx.core.entities.app.repository.sqlalchemy.models import DBWorkspace
...
def _find_alembic_ini() -> Optional[Path]:
    ...
    candidate_paths = [
        # Installed package path (wheel force-includes alembic into nhx/core/entities).
...
async def initialize_database(run_migrations: bool = True) -> None:
    ...
    """
    from nhx.core.entities.app.repository import _async_engine, get_async_session_maker
