...
Usage:
    ...
    python -m nhx.core.models.tasks.model_spec
"""
...
from nhx.core.models.tasks.model_spec.utils import infer_model_head_type
...
class ModelSpecRunner:
    ...
    def analyze_checkpoint(self, config: ModelSpecTaskConfig) -> ModelEntity:
        ...
        """
        from nhx.core.models.parallelism.api import find_minimum_gpus_from_metadata, infer_model_cfg_from_hf
