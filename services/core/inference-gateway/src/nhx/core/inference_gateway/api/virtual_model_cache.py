...
inside :func:`~nhx.core.inference_gateway.api.model_cache.refresh_model_cache` so both
...
def sync_config_ref_versions(
    ...
    - It is in :attr:`PrefetchResult.missing` **and** still present in *known_versions*
      ...
      :class:`~nemo_helix_plugin.inference_middleware.MiddlewareConfigNotFoundError`, so any
