...
from nhx.testing.client import ClientContext, ServiceFactory, create_test_client
...
def _build_app_context(
    *extra_services: ServiceFactory,
    ...
    from nhx.core.inference_gateway import config as igw_config_module
...
def _igw_loopback_context(
    ...
    """
    from nhx.core.inference_gateway.testing._loopback import serve_app_in_thread
...
def _build_loopback_harness(
    ...
    * ``get_platform_config`` is patched at IGW's middleware-registry
    ...
    from nhx.core.inference_gateway.testing._loopback import (
