...
Companion fixtures: :mod:`nhx.core.inference_gateway.testing.fixtures`.
"""
...
from nhx.testing.client import ClientContext
...
"""Workspace seeded by :func:`~nhx.testing.client.create_test_client` at
...
class IGWLoopbackHarness(IGWPluginHarness):
    ...
    :meth:`~nemo_helix_plugin.inference_middleware.InferenceMiddlewareCacheAccessor.get_openai_compatible_inference_url_and_model`
