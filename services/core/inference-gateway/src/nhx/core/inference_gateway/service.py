...
class InferenceGatewayService(Service):
    """Inference Gateway service for NeMo Helix."""

    dependencies: ClassVar[List[str]] = ["entities", "auth", "secrets", "models"]

    def __init__(self):
        """Initialize the inference gateway service."""
        super().__init__(name="inference-gateway", module_name="nhx.core.inference_gateway")
    ...
    @property
    def title(self) -> str:
        return "NeMo Helix Inference Gateway Microservice"
    ...
    def get_routers(self) -> List[RouterConfig]:
        ...
        from nhx.core.inference_gateway.api.v2 import models, openai, providers, virtual_models
    ...
    async def on_startup(self) -> None:
        ...
        from nhx.core.inference_gateway.api.middleware_registry import load_middleware_plugins
