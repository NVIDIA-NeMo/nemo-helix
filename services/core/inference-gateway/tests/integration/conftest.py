...
def mock_sidecar_image(docker_client: docker.DockerClient) -> Generator[str, None, None]:
    ...
    is patched in controller_with_docker_and_igw to return this name for 'nhx-core'.
    """
...
def controller_with_docker_and_igw(
    ...
    tuple[ModelsController, ModelCache, NeMoHelix, str, DockerTestContext, AsyncNeMoHelix], None, None
]:
