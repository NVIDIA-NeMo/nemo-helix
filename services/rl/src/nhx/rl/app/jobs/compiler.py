...
from nemo_helix_plugin.deployment import LORA_ENABLED_REQUIRED_MESSAGE, DeploymentParams
...
async def platform_job_config_compiler(
    ...
    *,
    ...
    method = job_spec.training_type.value.upper()
    logger.info(
        "Compiling NeMo-RL %s job to HelixJobSpec: model=%s, dataset=%s, output=%s, "
