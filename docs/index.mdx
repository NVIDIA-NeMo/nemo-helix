...
NeMo Helix exposes the same local services through the CLI, Python SDK, Studio, and REST APIs. First-party capabilities share platform infrastructure for inference, credentials, files, entities, and job execution.
