...
metric = LLMJudgeMetric(
    ...
    scores=[
        RubricScore(
            ...
            rubric=[
                Rubric(label="poor", value=0, description="Response is unhelpful or incorrect"),
                Rubric(label="acceptable", value=1, description="Response is partially correct"),
                Rubric(label="good", value=2, description="Response is correct and helpful"),
                Rubric(label="excellent", value=3, description="Response is comprehensive and insightful"),
            ],
        ...
        RubricScore(
            ...
            rubric=[
                Rubric(label="incomplete", value=0, description="Missing key information"),
                Rubric(label="partial", value=1, description="Covers main points but lacks detail"),
                Rubric(label="complete", value=2, description="Fully addresses the question"),
            ],
...
metric = LLMJudgeMetric(
    ...
    scores=[
        RubricScore(
            ...
            description="Overall quality of the response",
            rubric=[
                Rubric(label="poor", value=0, description="Response is unhelpful"),
                Rubric(label="good", value=1, description="Response is helpful"),
                Rubric(label="excellent", value=2, description="Response is exceptional"),
            ],
            parser=JSONScoreParser(json_path="quality"),
        )
    ],
