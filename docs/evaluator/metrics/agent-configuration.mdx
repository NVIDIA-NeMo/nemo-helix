...
For `evaluator.submit(...)` jobs, `api_key_secret` must name a NeMo Helix secret in the target workspace. See [Model API Authentication](/documentation/evaluate-models/metrics/model-configuration#model-api-authentication).
