...
All three shapes score with the **same `Metric` interface**. A deterministic/code scorer or an
LLM-as-a-judge scorer works in any of them — the difference is the shape of the input being scored,
not the scorer.
