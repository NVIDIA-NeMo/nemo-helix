...
- Published `nhx-tasks` and `nhx-gym-host` images for the platform release.
...
3. `nhx-tasks` and `nhx-gym-host` can be pulled by pods in the platform namespace.
