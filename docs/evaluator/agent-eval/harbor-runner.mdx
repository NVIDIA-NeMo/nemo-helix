...
- **Python ≥ 3.12** — Harbor is imported lazily, so the base SDK remains usable on Python 3.11
  without it; Harbor execution and existing-result adaptation require 3.12 or newer.
