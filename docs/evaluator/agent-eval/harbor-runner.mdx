...
- **Harbor**, installed from a NeMo Helix source checkout as shown below. Harbor is
...
The nemo-evaluator-sdk is not published as a standalone PyPI package. Use a NeMo Helix source checkout
(see the repository's [setup guide](https://github.com/NVIDIA-NeMo/nemo-helix/blob/main/SETUP.md)
