...
| Typical location | Repository root | Next to the agent (`agents/<agent-name>-ethos/ETHOS.md` on NeMo Helix) |
...
On NeMo Helix, invoke the `nemo-explore` skill to learn about your agent, and gather intent through some Q&A, then `nemo-ethos` writes `agents/<agent-name>-ethos/ETHOS.md`. You can also author the file by hand. See [Plugins and Skills](/documentation/agents/plugins-and-skills#coding-agent-skills).
