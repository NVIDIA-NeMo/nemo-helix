...
When omitted, the Analyst looks for `ETHOS.md`, then `README.md`, beside the profile.
...
and appends evidence to existing insights through the Insights API. Submission
does not discover a local profile or write a local Insights mirror.
...
This command does not discover `optimizer.yaml` or support local file mirrors.
