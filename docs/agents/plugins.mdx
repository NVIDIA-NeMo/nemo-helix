...
| `nemo-build-agent` | Scaffolds a Platform-managed agent.yaml from confirmed requirements and deploys it. Also helps migration from legacy NAT workflow YAML to agent.yaml |
