...
reaching the tool verbatim; the last two are read from the ATIF trajectory. Full steps are in `plugins/nemo-optimization/examples/hermes-optimize/README.md`.
