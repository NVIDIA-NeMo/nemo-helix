...
classification and on the analyzer being called exactly once, read from the ATIF
trajectory. Full steps are in `plugins/nemo-optimization/examples/hermes-optimize/README.md`.
