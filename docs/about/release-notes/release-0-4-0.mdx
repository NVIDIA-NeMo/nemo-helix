...
description: ""
---
NeMo Helix v0.4.0 introduces a research-preview optimization loop for
...
- Python 3.12 is now the minimum supported Python version for the source
  checkout and `nemo-helix` distribution.
...
- Platform API and `nemo-helix` Python SDK `0.4.0`
...
- **Python support.** Python 3.11 is no longer part of the supported source
  checkout or `nemo-helix` distribution matrix.
