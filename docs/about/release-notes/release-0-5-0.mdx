...
description: ""
---
NeMo Helix v0.5.0 focuses on productionizing the agent and customization
...
- Local SDK evaluation remains available without Helix services, with a
...
[Install NeMo Helix Helm Chart](/documentation/kubernetes-deployment/setup/helm/install).
...
- Platform API and `nemo-helix` Python SDK `0.5.0`
...
- Repository: [https://github.com/NVIDIA-NeMo/nemo-helix](https://github.com/NVIDIA-NeMo/nemo-helix)
- Issues: [https://github.com/NVIDIA-NeMo/nemo-helix/issues](https://github.com/NVIDIA-NeMo/nemo-helix/issues)
- GRPO and Reward Environments: [/documentation/customizer-reference/grpo-and-reward-environments](/documentation/customizer-reference/grpo-and-reward-environments)
- GRPO Environment Packages: [/documentation/customizer-reference/tutorials/grpo-environment-packages](/documentation/customizer-reference/tutorials/grpo-environment-packages)
