...
Agents are created and updated through the `nemo agents` CLI or Agents API. NeMo Studio reflects the current workspace state after the Helix services refresh.

## Related Topics

- [About Agents](/documentation/agents)
- [Optimize Agents](/documentation/agents/optimize-agents)
- [Add Guardrails to an Agent](/documentation/agents/add-guardrails)
