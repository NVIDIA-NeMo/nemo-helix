...
Start with the Quickstart to run NeMo Safe Synthesizer through the NeMo Helix CLI and Python SDK.

<Cards>

<Card title="Quickstart" href="/documentation/synthesize-safe-data">

Get started with the NeMo Safe Synthesizer microservice locally using the NeMo Helix CLI. Easiest for local testing.
