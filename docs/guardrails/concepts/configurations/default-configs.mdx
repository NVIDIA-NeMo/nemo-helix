...
nemo inference virtual-models create guarded-with-defaults \
  --default-model-entity system/nvidia-nemotron-3.5-lightning-30b-a3b \
...
client.inference.virtual_models.create(
    ...
    default_model_entity="system/nvidia-nemotron-3.5-lightning-30b-a3b",
    request_middleware=[
        {
...
```bash
nemo chat -m default/guarded-with-defaults "Hello"
```
