...
Set `GUARDRAILS_TUTORIAL_ASSETS` to the directory containing `street-scene.jpg`, or copy it into the working directory. You can also source a similar image from [https://commons.wikimedia.org/wiki/Main_Page](https://commons.wikimedia.org/wiki/Main_Page).
...
Use `car-audio-theft.jpg` from the directory configured by `GUARDRAILS_TUTORIAL_ASSETS`, or copy it into the working directory.
