...
Setting it always creates a deployment. If the base model is already serving and you only want the adapter to hot-reload onto it, omit the field rather than passing one.
