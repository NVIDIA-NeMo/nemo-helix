...
Pre-trained embeddings handle general retrieval well but underperform on specialized vocabulary, document structure, and query phrasing. Fine-tuning adapts the model to your corpus. Enterprise domains typically gain +5 to +20 absolute points of nDCG@10, with the largest gains where the base model has the least prior exposure, such as legal, biomedical, and internal engineering documents. Anything under +5 points usually points at data quality or coverage rather than at the recipe.
