...
[Run in Google Colab](https://colab.research.google.com/github/NVIDIA-NeMo/nemo-helix/blob/main/docs/customizer/tutorials/optimize-throughput.ipynb)

## About
Learn how to use the NeMo Helix Customizer to create a [LoRA](/documentation/customizer-reference/customization-concepts#nemo-ms-about-concepts-customization) (Low-Rank Adaptation) customization job optimized for higher tokens/GPU throughput and lower runtime.
...
from nemo_helix.types.shared import HelixJobStatusResponse
...
def get_elapsed_time(step: HelixJobStep) -> float:
...
- [Monitor customization metrics](/documentation/customizer-reference/tutorials/metrics) for training and validation loss.
