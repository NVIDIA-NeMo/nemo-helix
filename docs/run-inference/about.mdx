...
The NeMo Helix provides APIs for registering external model providers and routing inference requests through a unified gateway.
...
| Endpoint | Purpose |
|---|---|
| `GET {NHX_BASE_URL}/health/ready` | Readiness — returns 200 once dependent services are up |
| `GET {NHX_BASE_URL}/health/live` | Liveness |
