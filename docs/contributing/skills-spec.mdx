...
| 2 | `nemo-build-agent` | Scaffolds NAT workflow YAML and deploys |
...
description: >
  ...
  agent," "scaffold from this ethos," "deploy my agent," or provides an approved
  Ethos and is ready to ship.
triggers:
  - build the agent
  - scaffold from ethos
  - deploy my agent
...
compatibility: nemo-platform >= 0.1.0; macOS or Linux; requires `agents/<name>-ethos/ETHOS.md`
maturity: active
license: Apache-2.0
user-invocable: true
