...
| Python | 3.12, 3.13 | Use an isolated virtual environment. Python 3.12 is the lowest supported Python version and Python 3.13 is the highest supported Python version. |
...
- Python earlier than 3.12 or Python 3.14 and later.
