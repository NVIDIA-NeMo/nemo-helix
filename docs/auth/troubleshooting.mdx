...
4. Verify the PDP is reachable from Helix services. If using external OPA, check that the OPA sidecar/service is running and the bundle endpoint is accessible.
