...
description: ""
---
A checklist for connecting NeMo Helix to any OIDC-compliant identity provider not covered by the [Azure AD](/documentation/access-control/authentication/providers/azure-ad-entra-id) page.
