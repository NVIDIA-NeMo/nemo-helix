...
Entities are the underlying data objects that power the NeMo Helix. Models, datasets, jobs, configurations, and other resources are all represented as entities in the platform's storage layer.
