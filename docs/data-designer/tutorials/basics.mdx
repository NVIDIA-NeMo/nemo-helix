...
For more detail about column behavior, see the [open-source library's version](https://docs.nvidia.com/nemo/datadesigner/v0.9.3/tutorials/the-basics) of this tutorial.

## Prerequisites

Ensure you have completed the [tutorials prerequisites](/documentation/design-synthetic-data/tutorials#prerequisites).
...
model_configs = [
    dd.ModelConfig(
        ...
        model="nvidia/nemotron-3.5-lightning-30b-a3b",  # Use the `served_model_name` from the provider
        alias=MODEL_ALIAS,
...
Define the columns for your dataset. The [library documentation](https://docs.nvidia.com/nemo/datadesigner/v0.9.3/tutorials/the-basics) explains these column types in detail.
...
```bash
nemo data-designer create product_reviews.py --workspace default --num-records 30
```

### SDK Execution

The `DataDesignerResource` is your SDK interface for Data Designer execution on NeMo Helix. You can access it from an existing SDK instance:
...
client = NeMoHelix(base_url=base_url, workspace="default")
...
- **Column types:** Explore all available column types in the [library documentation](https://docs.nvidia.com/nemo/datadesigner/v0.9.3/concepts/columns)
- **Advanced features:** Learn about [processors](https://docs.nvidia.com/nemo/datadesigner/v0.9.3/concepts/processors) and [validation](https://docs.nvidia.com/nemo/datadesigner/v0.9.3/concepts/validators)
