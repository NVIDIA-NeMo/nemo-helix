...
Use `data_designer.config` to define your dataset. See the [library documentation](https://docs.nvidia.com/nemo/datadesigner/v0.9.3/getting-started/welcome) for comprehensive guides on column types, constraints, and processors.
...
<Card title="Generate Retrieval Training Data" href="/documentation/design-synthetic-data/tutorials/retrieval-generate">

Turn your own document corpus into judged question-and-answer pairs, ready for embedding fine-tuning. Hard-negative mining uses the current encoder to select non-answer passages that rank near each positive, giving the model useful examples to distinguish.

<small><span class="md-tag">intermediate</span> <span class="md-tag">data-designer</span> <span class="md-tag">retrieval</span></small>
