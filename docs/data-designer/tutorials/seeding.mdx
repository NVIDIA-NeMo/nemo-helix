...
For more detail about seed dataset behavior, see the [open-source library's version](https://docs.nvidia.com/nemo/datadesigner/v0.9.3/tutorials/seeding-with-an-external-dataset) of this tutorial.
...
client = NeMoHelix(base_url=base_url, workspace=WORKSPACE)
...
```bash
nemo data-designer preview medical_notes.py --workspace default
```

Generate a larger dataset:

```bash
nemo data-designer create medical_notes.py --workspace default --num-records 30
```
