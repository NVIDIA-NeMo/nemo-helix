...
[Run in Google Colab](https://colab.research.google.com/github/NVIDIA-NeMo/nemo-helix/blob/main/docs/data-designer/tutorials/retrieval-generate.ipynb)

Run Nemotron Stage 0 on NeMo Helix: turn a document corpus into judged question-and-answer pairs with `nemo data-designer retrieval-generate`. Use this when the training data has to come from your own documents.
...
- A running NeMo Helix at `NHX_BASE_URL`, default `http://localhost:8080`
