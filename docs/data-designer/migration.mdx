...
Data Designer configurations are mostly portable between the standalone library and the NeMo Helix plugin.
...
Most "locally-defined" aspects of Data Designer workloads have NeMo Helix equivalents:

| Area | Standalone library | NeMo Helix |
...
Some features of the standalone Data Designer library are not supported on NeMo Helix at all:
...
- **Library Docs:** Refer to the [open-source library documentation](https://docs.nvidia.com/nemo/datadesigner/v0.9.3/getting-started/welcome) for configuration details.
