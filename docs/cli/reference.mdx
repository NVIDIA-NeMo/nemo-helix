...
* `--training.retrieval.query-prefix`: Collator-side prefix; BiEncoderCollator adds a space.
* `--training.retrieval.passage-prefix`: Collator-side prefix; BiEncoderCollator adds a space.
