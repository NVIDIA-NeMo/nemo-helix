...
##### nemo evaluator retrieve-eval run
...
```shell
nemo evaluator retrieve-eval run [OPTIONS]
```
...
##### nemo evaluator retrieve-eval submit
...
```shell
nemo evaluator retrieve-eval submit [OPTIONS]
```
